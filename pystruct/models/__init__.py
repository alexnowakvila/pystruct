...
from .generalized_crf import GeneralizedCRF, GeneralizedChainCRF, GeneralizedGraphCRF
...
from .generalized_unstructured_svm import GeneralizedMultiClassClf
...
__all__ = ["StructuredModel", "CRF", "GridCRF", "GraphCRF",
           ...
           "EdgeFeatureLatentNodeCRF", "GeneralizedMultiClassClf",
           "GeneralizedCRF", "GeneralizedChainCRF", "GeneralizedGraphCRF"]
